...
**Using Postman:** Import `http://localhost:8000/openapi.json` directly into Postman (File → Import → Link) and it will generate a full collection from the OpenAPI spec automatically.
